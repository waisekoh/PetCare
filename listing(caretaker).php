...
<div class="topnav">
                <a href="login-ed_caretaker.php">Home</a> <!-- insert js -->
    ...
    <div class="col-sm-6" style="background-color:#DCC7AA;">
      <div class="combine"><div class="petprofile"><img src="/images/default.jpg" height= "145"></div>
        <div class="petinfo">
            ...
            <div class="bidinfo" class="review" style="width:200px;height:120px;border:1px solid #000;text-align:left"><div class="form-group"><label for="inputMinBid">Mininum Bid:</label><input type="text" class="form-control" id="inputMinBid"></div> <!-- insert sql -->
                <div class="form-group"><label for="inputPetID">PetID:</label><input type="text" class="form-control" id="inputPetID"></div><br><button>Bid</button><p></div><br> <!-- insert sql -->
